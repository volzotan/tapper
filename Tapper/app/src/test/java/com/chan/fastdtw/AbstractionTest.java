...
import com.chan.fastdtw.timeseries.PAA;
...
import com.chan.fastdtw.dtw.WarpPath;
import com.chan.fastdtw.dtw.SearchWindow;
import com.chan.fastdtw.dtw.WarpPathWindow;
...
public class AbstractionTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final WarpPath coarsePath = com.chan.fastdtw.dtw.DTW.getWarpPathBetween(shrunkI, shrunkJ, distFn);
            ...
            final TimeWarpInfo info = com.chan.fastdtw.dtw.DTW.getWarpInfoBetween(tsI, tsJ, w, distFn);
