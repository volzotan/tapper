...
package com.chan.fastdtw.timeseries;
...
public class TimeSeries
{
   ...
   // PRIVATE DATA
   private final ArrayList<String> labels;   // labels for each column
   private final ArrayList<Double> timeReadings;        // ArrayList of Double
   private final ArrayList<TimeSeriesPoint> tsArray;    // ArrayList of TimeSeriesPoint.. no time
