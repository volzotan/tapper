...
package com.chan.fastdtw.dtw;

import com.chan.fastdtw.matrix.ColMajorCell;
...
public class DTW
{
   ...
   // FUNCTIONS
   public static double calcWarpCost(com.chan.fastdtw.dtw.WarpPath path, TimeSeries tsI, TimeSeries tsJ, DistanceFunction distFn)
   {
      double totalCost = 0.0;

      for (int p=0; p<path.size(); p++)
      {
         final com.chan.fastdtw.matrix.ColMajorCell currWarp = path.get(p);
